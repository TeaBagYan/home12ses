function new_comment(){
  ...
  let user_active= localStorage.getItem('active_user');
  b.innerHTML = user_active +" : "+ text
  a.append(b)
...
function login() {
  ...
  if (localStorage.getItem(uname) != null ){
      ...
      document.getElementById('active_name').textContent = localStorage['active_user']
      }else if(upass != user.user_password){
        document.getElementById('error').textContent = "Ошибка неверный пароль"
      }
